...
public class PressurePlatesRegistries {
    ...
    public static final String SILENCE_OBSIDIAN_PRESSURE_PLATE = "silence_obsidian_pressure_plate";

    public static final String MOSSY_COBBLESTONE_PRESSURE_PLATE         = "mossy_cobblestone_pressure_plate";
    public static final String SILENCE_MOSSY_COBBLESTONE_PRESSURE_PLATE = "silence_mossy_cobblestone_pressure_plate";
}
